  ...
  return (
    <>
      ...
      >
        ...
        >
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=kprahul1143@gmail.com"
            target="_blank"
        ...
        >
          ...
          <p className="text-xl font-medium">MERN Stack Developer</p>
        </motion.div>
        ...
        >
          <img src={image} alt="" className="w-96 rounded-xl " />
        </motion.div>
        ...
        >
          <button className="bg-black hover:bg-white cursor-pointer hover:text-black hover:border-gray-400 hover:border text-white rounded-xl px-3 py-3">
            Download CV
          </button>
          <p className="text-md font-medium">📍Tirunelveli, Tamil Nadu, India</p>
        </motion.div>
      </motion.section>
    </>
  );
